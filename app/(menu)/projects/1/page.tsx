...
export default function ProjectOne() {
  ...
  const project = {
    title: "Project One",
    description:
      "This is a detailed description of Project One. It outlines the project's objectives, the challenges faced, the solutions implemented, and the results achieved.",
    imageUrl: "/images/1.jpg", // Path to the image file
    details: [
      {
        title: "Background",
